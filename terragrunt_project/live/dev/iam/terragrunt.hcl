...
dependency "s3" {
  ...
  # mock outputs from dependencies using mock_outputs. 
  # This allows us to plan successfully without worrying about 
  # getting errors that required variables aren’t passed in.
